package ru.sorokinkv.homework03.aop;
...
public class CacheCardsAspect {
    ...
    @Around("execution(public * ru.sorokinkv.homework03.dao.QuestionDao.getAllQuestions())")
    ...
    @Around("execution(public * ru.sorokinkv.homework03.dao.AnswerDao.getAllAnswers())")
